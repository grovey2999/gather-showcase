...
every church. It holds children's medical notes, so safety came first: per-record encryption,
one database per district, one permission table, and tests that attack every boundary.

[Gather showcase](https://github.com/grovey2999/gather-showcase): screenshots and security
write-up. Source private; walkthrough on request.
